from abc import ABCMeta, abstractmethod # Вспомогательный класс, имеющий ABCMetaметакласс.
#С помощью этого класса можно создать абстрактный базовый класс, просто унаследовав его от ABC
